                        ...
                        <div className="lg:w-2/3 lg:ps-16 ps-8 pt-12 lg:pt-0">
                            <div className='flex flex-row justify-between'>
                                ...
                                <div className='flex flex-row'>
                                    <Link href="" ><svg id="heart-icon" xmlns="http://www.w3.org/2000/svg" width={24} viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round">
                                        <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z" />
                                    </svg>
                                    </Link>
                                    <Link href="/" ><svg className='mx-4' xmlns="http://www.w3.org/2000/svg" width={24} viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round">
                                        <line x1="22" y1="2" x2="11" y2="13"></line>
                                        <polygon points="22 2 15 22 11 13 2 9 22 2"></polygon>
                                    </svg>
                                    </Link>
                                    <Link href="/" ><svg xmlns="http://www.w3.org/2000/svg" width={24} viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round">
